...
"[Compound-protein Interaction Prediction with End-to-end Learning of Neural Networks for Graphs and Sequences (Bioinformatics, 2018)](https://academic.oup.com/bioinformatics/advance-article-abstract/doi/10.1093/bioinformatics/bty535/5050020?redirectedFrom=PDF)". It uses Graph Neural Network for learning the representations of compounds and Convolutional Neural Networks for proteins. 
...
In this repository, I implement Protein Transformer for learning protein representations. It takes the advantage of self-attention and can capture the long-distance interaction between amino acid residues. This brings about significant improvements in prediction power.
