...
class positional_encoder(nn.Module):
    def __init__(self, d_model, dropout, max_len=13001):
...
if __name__ == "__main__":
    ...
    if (len(sys.argv[1:])==19):
        ...
        (DATASET,dataname, radius, ngram, dim, d_ff, layer_gnn, layer_output,heads, n_encoder,n_decoder,
         lr, lr_decay, decay_interval, weight_decay, iteration, warmup_step,
         dropout,setting,gpu) = sys.argv[1:]
    
    '''
    ('human','H_1_1','2','3','10','10','3','1','2','2','1','1e-4','0.5','10',
                         '1e-6','100','20','0.1','trial','0')
    '''
    #sys.argv[1:]
