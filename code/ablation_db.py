...
if __name__ == "__main__":
    ...
    dataset_dev = dataset[0:5585]
    dataset_train = dataset[5585:5585+49968]
    dataset_test = dataset[5585+49968:5585+49968+5482]
    ...
    file_AUCs =( '../output/result/Trans_DB,'+
    DATASET+',' + 
    str(ngram)+'gram'+
    ',Dim'+str(dim)+
    ',heads'+ str(heads)+
    ...
    file_model = ('../output/model/Transformer_DB,'
    +DATASET +
    ',Dim_'+str(dim) +
    ',Heads'+str(heads) +
    ',Enc_'+str(n_encoder) +
